...
const TERM_PAIRS = [
  ...
  },
  {
    id: 3,
    term: 'emoji',
    definition: 'Smile face',
    description: 'Expression icon like 😊'
  },
  {
    id: 4,
    term: 'tag',
...
export default function Phase4_2Step4RemedialA2TaskA() {
  ...
  return (
    <Box sx={{ maxWidth: 1200, mx: 'auto', p: 3 }}>
      ...
      {/* Quick Match Buttons */}
      {!showResults && (
        <Paper elevation={2} sx={{ p: 2, mt: 3, backgroundColor: 'grey.50' }}>
          <Typography variant="subtitle1" gutterBottom fontWeight="bold">
            Quick Match: Select a definition box above, then click a term below to match
          </Typography>
