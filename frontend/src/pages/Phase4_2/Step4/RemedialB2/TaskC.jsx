...
/**
 * Phase 4.2 Step 4 - Remedial B2 - Task C: Matching Game
 * Match 8 terms to definitions
 * Pairs: hashtag—Discoverability, caption—Engagement text, emoji—Visual emotion,
 *        tag—Mention reach, call-to-action—Prompt action, story—Temporary content,
 *        engagement—Likes/comments, viral—Fast spread
 * Score: 8 points (1 per correct match)
 * Pass: 6/8
 */
...
export default function RemedialB2TaskC() {
  ...
  const handleContinue = () => {
    navigate('/phase4_2/step4/remedial/b2/taskD')
  }
      ...
      <Box sx={{ maxWidth: 1200, mx: 'auto', p: 3 }}>
        <Paper elevation={0} sx={{ p: 3, mb: 3, background: 'linear-gradient(135deg, #e67e22 0%, #d35400 100%)', color: 'white' }}>
          ...
          <Typography variant="h5" gutterBottom>
            Level B2 - Task C: Matching Game
          </Typography>
          <Typography variant="body1">
            Match 8 terms to their definitions!
          </Typography>
        </Paper>
        ...
        <Paper elevation={2} sx={{ p: 3, mb: 3 }}>
          <CharacterMessage
            ...
            message="Welcome to the Matching Game! Match 8 social media terms to their correct definitions. Click a term, then click its matching definition. All correct matches earn you 8 points! Ready? Let's start!"
          />
        </Paper>
        ...
        <Paper elevation={6} sx={{ p: 4, textAlign: 'center', background: 'linear-gradient(135deg, #e67e22 0%, #d35400 100%)' }}>
          ...
          <Typography variant="h6" sx={{ color: 'white', mb: 4 }}>
            8 Terms • 8 Definitions • Match Them All!
          </Typography>
    ...
    return (
      <Box sx={{ maxWidth: 1200, mx: 'auto', p: 3 }}>
        <Paper elevation={0} sx={{ p: 3, mb: 3, background: 'linear-gradient(135deg, #e67e22 0%, #d35400 100%)', color: 'white' }}>
          ...
          <Typography variant="h5" gutterBottom>
            Level B2 - Task C: Matching Game - Results
          </Typography>
        </Paper>
          ...
          <Box sx={{ color: 'white', textAlign: 'center' }}>
            ...
            {passed && (
              <Alert severity="success" sx={{ mt: 2, backgroundColor: 'rgba(46, 204, 113, 0.9)' }}>
                <strong>Excellent!</strong> You matched most terms correctly! Great vocabulary knowledge!
              </Alert>
            )}
          </Box>
        </Paper>
        ...
        <Box sx={{ textAlign: 'center' }}>
          ...
          >
            Continue to Task D: Spelling & Explain
          </Button>
        </Box>
      </Box>
    )
