...
const PASS_THRESHOLD = 38 // 38/48 to proceed (approximately 79%)
...
export default function Phase4_2Step4RemedialC1Results() {
  ...
  const handleContinue = () => {
    if (results.passed) {
      ...
      sessionStorage.removeItem('phase4_2_step4_c1_taskA_score')
      sessionStorage.removeItem('phase4_2_step4_c1_taskB_score')
      sessionStorage.removeItem('phase4_2_step4_c1_taskC_score')
      sessionStorage.removeItem('phase4_2_step4_c1_taskD_score')
      sessionStorage.removeItem('phase4_2_step4_c1_taskE_score')
      sessionStorage.removeItem('phase4_2_step4_c1_taskF_score')
      sessionStorage.removeItem('phase4_2_step4_c1_taskG_score')
      sessionStorage.removeItem('phase4_2_step4_c1_taskH_score')
      navigate('/dashboard')
    } else {
      // Retry from Task A
      sessionStorage.removeItem('phase4_2_step4_c1_taskA_score')
      ...
      sessionStorage.removeItem('phase4_2_step4_c1_taskG_score')
      sessionStorage.removeItem('phase4_2_step4_c1_taskH_score')
      navigate('/phase4_2/step/4/remedial/c1/taskA')
    }
  }
    ...
    <Box sx={{ maxWidth: 1100, mx: 'auto', p: 3 }}>
      ...
      >
        ...
        <Alert severity={results.passed ? 'success' : 'warning'} sx={{ mt: 2 }}>
          {results.passed ? (
            <Typography>
              You scored <strong>{results.total}/48</strong>, which is above the required <strong>{PASS_THRESHOLD}/48</strong> to proceed!
            </Typography>
          ) : (
            <Typography>
              You scored <strong>{results.total}/48</strong>. You need at least <strong>{PASS_THRESHOLD}/48</strong> to proceed. Please try again!
            </Typography>
          )}
        </Alert>
      </Paper>
