      ...
      >
        ...
        >
          ...
          <CharacterMessage speaker="Emna" direction="left">
            Welcome to the Debate Duel! Master advanced grammar by using subjunctives and modals in 6 powerful debate statements about Instagram strategy.
          </CharacterMessage>
          ...
          <Box sx={{ mt: 4, mb: 4, p: 3, bgcolor: '#e8eaf6', borderRadius: 2 }}>
            ...
            <Stack spacing={1.5} sx={{ textAlign: 'left' }}>
              ...
              <Typography sx={{ color: '#2c3e50' }}>
                <strong>🏆 Scoring:</strong> +1 for each correct form (6 points = 10/10)
              </Typography>
            </Stack>
          </Box>
      ...
      >
        ...
        >
          ...
          <Box sx={{ mt: 4, display: 'flex', gap: 2, justifyContent: 'center' }}>
            <Button
              onClick={() => navigate('/phase4_2/step/4/remedial/c1/taskH')}
              variant="contained"
              size="large"
              sx={{
                background: 'linear-gradient(45deg, #8e44ad 30%, #3498db 90%)',
