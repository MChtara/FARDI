...
import { Box, Paper, Typography, Button, Avatar, IconButton, Chip, LinearProgress, Select, MenuItem, FormControl } from '@mui/material'
 ...
 * WhatsApp/Messenger-style chat interface - complete dialogue explaining social media terms
 * 6 blanks from word bank
 * Content: Ms. Mabrouki: "Explain hashtag." You: "[Hashtag] increases [reach] and [engagement]."
 * Lilia: "Caption role?" You: "[Caption] with [emoji] and [call-to-action] engages people."
 * Score: 1 point per correct term (6 total)
 * Pass threshold: 5/6
 */
    ...
    return (
      <Box sx={{ maxWidth: 1200, mx: 'auto', p: 3 }}>
        ...
        <Paper elevation={6} sx={{ p: 4, textAlign: 'center', mb: 3 }}>
          <Typography variant="h3" gutterBottom fontWeight="bold" sx={{ color: passed ? '#27ae60' : '#e74c3c' }}>{score} / 6</Typography>
        ...
        <Box sx={{ textAlign: 'center' }}>
          <Button variant="contained" size="large" onClick={() => navigate('/phase4_2/step3/remedial/b2/taskB')} sx={{ py: 2, px: 6, fontSize: '1.1rem', fontWeight: 'bold', background: 'linear-gradient(135deg, #27ae60 0%, #229954 100%)', '&:hover': { background: 'linear-gradient(135deg, #229954 0%, #1e8449 100%)' } }}>
  ...
  return (
    <Box sx={{ maxWidth: 1200, mx: 'auto', p: 3 }}>
      <Paper elevation={0} sx={{ p: 3, mb: 3, background: 'linear-gradient(135deg, #e74c3c 0%, #c0392b 100%)', color: 'white' }}>
        ...
        <Typography variant="body1">Complete the dialogue explaining social media terms!</Typography>
      </Paper>

      <Paper elevation={2} sx={{ p: 3, mb: 3 }}>
        <CharacterMessage character="MS. MABROUKI" message="Welcome to the Role-Play Saga! This is a group chat conversation about explaining social media post elements. Read the questions and complete your responses by selecting words from the word bank. Send each complete message to continue!" />
      </Paper>
