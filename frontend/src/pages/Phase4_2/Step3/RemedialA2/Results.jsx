    ...
    <Box sx={{ maxWidth: 900, mx: 'auto', p: 3 }}>
      ...
      >
        <Typography variant="h5" gutterBottom>
          Phase 4.2 Step 3 - Level A2 Remedial
        </Typography>
        ...
        <Alert severity="info" sx={{ mb: 3 }}>
          ...
          {results.taskA < 6 && (
            <Typography variant="body2">
              • Review Task A: Practice matching social media terms with their meanings
            </Typography>
          )}
          {results.taskB < 6 && (
            <Typography variant="body2">
              • Review Task B: Focus on understanding when to use each social media term
            </Typography>
          )}
          {results.taskC < 4 && (
            <Typography variant="body2">
              • Review Task C: Practice writing simple sentences with "is" and proper capitalization
            </Typography>
          )}
        </Alert>
      )}
