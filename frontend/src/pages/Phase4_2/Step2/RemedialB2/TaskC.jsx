 ...
 * Terms from spec: hashtag-Discoverability, caption-Engagement, emoji-Emotion,
 * call-to-action-Conversion, tag-Network, story-Temporality, viral-Reach, engagement-Interaction
...
export default function RemedialB2TaskC() {
  ...
  const handleContinue = () => {
    navigate('/phase4_2/step2/remedial/b2/taskD')
  }
          ...
          <Box sx={{ color: 'white', textAlign: 'center' }}>
            ...
            {perfectScore && (
              <Alert severity="success" sx={{ mt: 2, backgroundColor: 'rgba(46, 204, 113, 0.9)' }}>
                <strong>Amazing!</strong> You matched all terms perfectly! You're a social media planning expert!
              </Alert>
            )}
          </Box>
        </Paper>
