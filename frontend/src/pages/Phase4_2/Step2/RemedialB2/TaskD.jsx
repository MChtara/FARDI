...
const TERMS = [
  {
    id: 1,
    word: 'hashtag',
    clue: 'Symbol helping people discover your post',
    expectedConcepts: ['symbol', 'discovery', 'search', 'categorize']
  },
  {
    id: 2,
    word: 'caption',
    clue: 'Descriptive text accompanying your image',
    expectedConcepts: ['text', 'describe', 'context', 'story']
  },
  {
    id: 3,
    word: 'viral',
    clue: 'Content spreading rapidly to millions',
    expectedConcepts: ['spread', 'fast', 'popular', 'shares']
  },
  {
    id: 4,
    word: 'emoji',
    clue: 'Visual icons expressing emotions',
    expectedConcepts: ['icon', 'emotion', 'visual', 'feeling']
  },
  {
    id: 5,
    word: 'engagement',
    clue: 'Total user interactions with content',
    expectedConcepts: ['interaction', 'likes', 'comments', 'shares']
  },
  {
    id: 6,
    word: 'story',
    clue: 'Temporary 24-hour post format',
...
export default function RemedialB2TaskD() {
  ...
  const handleContinue = () => {
    navigate('/phase4_2/step2/remedial/b2/results')
  }
          ...
          <Box sx={{ textAlign: 'center' }}>
            <Button
              ...
              sx={{
                ...
                fontSize: '1.4rem',
                fontWeight: 'bold',
                backgroundColor: currentFeedback?.explanationScore === 1 ? '#27ae60' : '#e74c3c',
                color: 'white',
                '&:hover': {
                  backgroundColor: currentFeedback?.explanationScore === 1 ? '#229954' : '#c0392b'
                }
              }}
            >
