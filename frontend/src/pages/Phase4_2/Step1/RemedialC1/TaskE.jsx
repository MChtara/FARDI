 ...
 * Mixed tenses grammar exercise - Complete 6 sentences using different tenses with social media terms
...
const TENSE_SENTENCES = [
  {
    id: 1,
    odyssey: 'Odyssey 1',
    character: 'Social Media Historian',
    avatar: '📱',
    before: 'Hashtag for organizing',
    infinitive: 'to be',
  ...
  },
  {
    id: 2,
    odyssey: 'Odyssey 2',
    character: 'Content Strategist',
    avatar: '✍️',
    before: 'Caption engagement',
    infinitive: 'to increase',
    answer: 'increased',
    tenseType: 'Simple Past',
    after: 'last quarter.',
    concept: 'simple past for completed action in specific past time'
  },
  {
    id: 3,
    odyssey: 'Odyssey 3',
  ...
  },
  {
    id: 4,
    odyssey: 'Odyssey 4',
    character: 'Viral Campaign Manager',
    avatar: '🚀',
    before: 'Viral content spread',
    infinitive: 'to be',
    answer: 'was',
    tenseType: 'Simple Past',
    after: 'key in 2023 campaign.',
    concept: 'simple past for historical specific event'
  },
  {
    id: 5,
    odyssey: 'Odyssey 5',
    character: 'Influencer Analyst',
    avatar: '⭐',
    before: 'Tag strategy boost reach',
    infinitive: 'to help',
    answer: 'has always helped',
    tenseType: 'Present Perfect',
    after: 'influencers grow.',
    concept: 'present perfect with "always" for ongoing truth'
  },
  {
    id: 6,
    odyssey: 'Odyssey 6',
    character: 'Engagement Specialist',
    avatar: '💬',
    before: 'Story format is interactive',
      ...
      <Box sx={{ maxWidth: 1200, mx: 'auto', p: 3 }}>
        <Paper elevation={0} sx={{ p: 3, mb: 3, background: 'linear-gradient(135deg, #8e44ad 0%, #6c3483 100%)', color: 'white' }}>
          ...
          <Typography variant="body1" sx={{ color: 'white' }}>
            Mixed tenses grammar exercise - Master verb tenses with social media contexts!
          </Typography>
        </Paper>
        ...
        <Paper elevation={2} sx={{ p: 3, mb: 3 }}>
          <CharacterMessage
            ...
            message="Welcome to Tense Odyssey! 🗺️ Embark on a journey through different verb tenses with social media terms. Complete 6 sentences using the correct tense (present perfect, simple past, simple present, etc.). Each correct tense = 1 point. Total: 6 points! Ready to navigate through time? 🚀"
          />
        </Paper>
          ...
          <Box sx={{ mb: 4 }}>
            <Paper elevation={3} sx={{ p: 3, backgroundColor: 'rgba(255,255,255,0.95)', maxWidth: 700, mx: 'auto' }}>
              ...
              <Typography variant="body1" sx={{ color: '#34495e', textAlign: 'left' }}>
                ...
                • "since 2007" → Present Perfect<br />
                • "last quarter" → Simple Past<br />
