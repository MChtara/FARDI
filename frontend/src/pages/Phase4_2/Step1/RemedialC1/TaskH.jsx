 ...
 * Error correction game - Fix 6 sentences with social media verb agreement errors
...
const ERROR_SENTENCES = [
  {
    ...
    avatar: '🔍',
    before: 'Hashtag campaign',
    infinitive: 'to be',
    wrongWord: 'are',
    after: 'viral.',
    answer: 'is',
    errorType: 'Subject-Verb Agreement',
    concept: 'Singular subject "Hashtag campaign" requires singular verb "is"'
  },
  {
    id: 2,
    ...
    answer: 'uses',
    errorType: 'Subject-Verb Agreement',
    concept: 'Singular subject "Caption strategy" requires third-person singular "uses"'
  },
  {
    id: 3,
    ...
    answer: 'is',
    errorType: 'Subject-Verb Agreement',
    concept: 'Singular subject "content" requires singular verb "is"'
  },
  {
    id: 4,
    ...
    answer: 'is',
    errorType: 'Subject-Verb Agreement',
    concept: 'Singular subject "format" requires singular verb "is"'
  },
  {
    id: 5,
    crusader: 'Grammar Guardian',
    avatar: '🛡️',
    before: 'Creative tags',
    infinitive: 'to make',
    wrongWord: 'makes',
    after: 'posts memorable.',
    answer: 'make',
    errorType: 'Subject-Verb Agreement',
    concept: 'Plural subject "tags" requires plural verb "make"'
  },
  {
    id: 6,
    crusader: 'Accuracy Champion',
    avatar: '👑',
    before: 'Authentic engagement',
    infinitive: 'to be',
    wrongWord: 'are',
    after: 'valuable.',
    answer: 'is',
    errorType: 'Subject-Verb Agreement',
    concept: 'Singular subject "engagement" requires singular verb "is"'
  }
]
      ...
      >
        ...
        >
          ...
          <Box sx={{ mb: 3, p: 2, bgcolor: '#fff3cd', borderRadius: 2, textAlign: 'left' }}>
            ...
            <Typography variant="body2" sx={{ color: '#856404' }}>
              • Singular subjects: use "is", "uses", "makes" (with -s/-es)
            </Typography>
            <Typography variant="body2" sx={{ color: '#856404' }}>
      ...
      >
        ...
        >
          ...
          <Box sx={{ mt: 4, display: 'flex', gap: 2, justifyContent: 'center' }}>
            <Button
              onClick={() => navigate('/phase4_2/step/1/remedial/c1/results')}
              variant="contained"
              size="large"
              sx={{
                background: 'linear-gradient(45deg, #e74c3c 30%, #c0392b 90%)',
