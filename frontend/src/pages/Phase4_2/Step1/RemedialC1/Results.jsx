...
export default function Phase4_2RemedialC1Results() {
  ...
  const handleContinue = () => {
    if (results.passed) {
      ...
      sessionStorage.removeItem('phase4_2_remedial_c1_taskA_score')
      sessionStorage.removeItem('phase4_2_remedial_c1_taskB_score')
      sessionStorage.removeItem('phase4_2_remedial_c1_taskC_score')
      sessionStorage.removeItem('phase4_2_remedial_c1_taskD_score')
      sessionStorage.removeItem('phase4_2_remedial_c1_taskE_score')
      sessionStorage.removeItem('phase4_2_remedial_c1_taskF_score')
      sessionStorage.removeItem('phase4_2_remedial_c1_taskG_score')
      sessionStorage.removeItem('phase4_2_remedial_c1_taskH_score')
      navigate('/dashboard')
    } else {
      // Retry from Task A
      sessionStorage.removeItem('phase4_2_remedial_c1_taskA_score')
      ...
      sessionStorage.removeItem('phase4_2_remedial_c1_taskG_score')
      sessionStorage.removeItem('phase4_2_remedial_c1_taskH_score')
      navigate('/phase4_2/step/1/remedial/c1/taskA')
    }
  }
    ...
    <Box sx={{ maxWidth: 1100, mx: 'auto', p: 3 }}>
      ...
      >
        <Typography variant="h5" gutterBottom>
          Phase 4.2 Step 1 - Level C1 Remedial
        </Typography>
