...
export default function Phase4_2RemedialA1Results() {
  ...
  const handleContinue = () => {
    if (results.passed) {
      ...
      sessionStorage.removeItem('phase4_2_remedial_a1_taskB_score')
      sessionStorage.removeItem('phase4_2_remedial_a1_taskC_score')
      navigate('/phase4_2/step/1/remedial/a1/taskA')
    }
  }
    ...
    <Box sx={{ maxWidth: 900, mx: 'auto', p: 3 }}>
      ...
      >
        <Typography variant="h5" gutterBottom>
          Phase 4.2 Step 1 - Level A1 Remedial
        </Typography>
      ...
      <Paper elevation={2} sx={{ p: 3, mb: 3 }}>
        <CharacterMessage
          ...
          message={
            results.passed
              ? "Excellent work! You've mastered the A1 social media vocabulary. You can proceed!"
