  ...
  return (
    <Box sx={{ maxWidth: 1200, mx: 'auto', p: 3 }}>
      <Paper elevation={0} sx={{ p: 3, mb: 3, background: 'linear-gradient(135deg, #8e44ad 0%, #6c3483 100%)', color: 'white', borderRadius: 2 }}>
        ...
        <Typography variant="h5" gutterBottom>Step 1: Engage - Interaction 2</Typography>
        <Typography variant="body1">Peer Feedback Experience</Typography>
      </Paper>

      <Paper elevation={2} sx={{ p: 3, mb: 3, borderRadius: 2 }}>
        <Typography variant="body1" sx={{ fontStyle: 'italic', mb: 2 }}>SKANDER: "Share a time when you gave or received feedback. What happened? Was it helpful? Use these words: feedback, helpful, suggestion, improve."</Typography>
      </Paper>
      ...
      {evaluation && (
        <Paper elevation={3} sx={{ p: 3, mb: 3, backgroundColor: 'success.lighter', border: '2px solid', borderColor: 'success.main', borderRadius: 2 }}>
          ...
          {submitted && (
            <Button variant="contained" onClick={() => navigate('/phase6/subphase/2/step/1/interaction/3')} fullWidth size="large"
