...
/**
 * Phase 5 SubPhase 2 Step 1 - Remedial C1 - Task C: Advanced Quiz
...
export default function Phase5SubPhase2Step1RemedialC1TaskC() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      await phase5API.logRemedialActivity(1, 'C1', 'C', correctCount, 6, 2) // subphase 2
    } catch (error) {
  ...
  const handleContinue = () => {
    navigate('/phase5/subphase/2/step/1/remedial/c1/task/d')
  }
