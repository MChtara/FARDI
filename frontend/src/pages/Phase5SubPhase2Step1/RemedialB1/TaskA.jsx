...
/**
 * Phase 5 SubPhase 2 Step 1 - Remedial B1 - Task A: Negotiation Simulator
...
export default function Phase5SubPhase2Step1RemedialB1TaskA() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      await phase5API.logRemedialActivity(1, 'B1', 'A', finalScore, 4, 2) // subphase 2
    } catch (error) {
  ...
  const handleContinue = () => {
    navigate('/phase5/subphase/2/step/1/remedial/b1/task/b')
  }
