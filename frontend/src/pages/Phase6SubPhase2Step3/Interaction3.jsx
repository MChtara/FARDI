  ...
  return (
    <Box sx={{ maxWidth: 1200, mx: 'auto', p: 3 }}>
      ...
      <Paper elevation={2} sx={{ p: 3, mb: 3, borderRadius: 2 }}>
        <Typography variant="body1" sx={{ fontStyle: 'italic' }}>Ryan: "Play Sushi Spell with feedback terms. Spell: feedback, constructive, positive, suggestion, polite. Then explain one term you spelled."</Typography>
      </Paper>
