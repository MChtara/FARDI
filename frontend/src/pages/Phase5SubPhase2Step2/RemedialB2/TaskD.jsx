...
/**
 * Phase 5 SubPhase 2 Step 2 - Remedial B2 - Task D: Spelling & Explain
...
export default function Phase5SubPhase2Step2RemedialB2TaskD() {
  ...
  const handleSubmit = async () => {
    ...
    setSubmitted(true)
    sessionStorage.setItem('phase5_subphase2_step2_remedial_b2_taskD_score', correctCount.toString())

    try {
      await phase5API.logRemedialActivity(2, 'B2', 'D', correctCount, 6, 2) // step 2, subphase 2
    } catch (error) {
