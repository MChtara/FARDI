...
/**
 * Phase 5 SubPhase 2 Step 2 - Level A2 - Task C: Sentence Builder
...
export default function Phase5SubPhase2Step2RemedialA2TaskC() {
  ...
  const handleSubmit = async () => {
    ...
    setScore(finalScore)
    setSubmitted(true)
    sessionStorage.setItem('phase5_subphase2_step2_remedial_a2_taskC_score', finalScore.toString())

    try {
      await phase5API.logRemedialActivity(2, 'A2', 'C', finalScore, 6, 2) // step 2, subphase 2
    } catch (error) {
