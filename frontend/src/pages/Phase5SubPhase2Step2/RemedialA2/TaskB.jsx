...
/**
 * Phase 5 SubPhase 2 Step 2 - Level A2 - Task B: Fill Frenzy
...
export default function Phase5SubPhase2Step2RemedialA2TaskB() {
  ...
  const handleSubmit = async () => {
    ...
    setScore(finalScore)
    setSubmitted(true)
    sessionStorage.setItem('phase5_subphase2_step2_remedial_a2_taskB_score', finalScore.toString())

    try {
      await phase5API.logRemedialActivity(2, 'A2', 'B', finalScore, 6, 2) // step 2, subphase 2
    } catch (error) {
  ...
  const handleContinue = () => {
    navigate('/phase5/subphase/2/step/2/remedial/a2/task/c')
  }
