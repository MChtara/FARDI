...
/**
 * Phase 5 SubPhase 2 Step 2 - Remedial C1 - Task A: Debate Simulation
...
export default function Phase5SubPhase2Step2RemedialC1TaskA() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      await phase5API.logRemedialActivity(2, 'C1', 'A', finalScore, 4, 2) // step 2, subphase 2
    } catch (error) {
  ...
  const handleContinue = () => {
    navigate('/phase5/subphase/2/step/2/remedial/c1/task/b')
  }
