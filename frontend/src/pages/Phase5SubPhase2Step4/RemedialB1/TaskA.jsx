...
/**
 * Phase 5 SubPhase 2 Step 4 - Remedial B1 - Task A: Negotiation Gap Fill
 * Fill gaps in dialogue giving instructions
 */
...
const SENTENCES = [
  ...
  'Emna: Then?',
  'You: [Then] check ticket and [guide].'
]
...
export default function Phase5SubPhase2Step4RemedialB1TaskA() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      await phase5API.logRemedialActivity(4, 'B1', 'A', finalScore, 4, 2) // step 4, subphase 2
    } catch (error) {
  ...
  const handleContinue = () => {
    navigate('/phase5/subphase/2/step/4/remedial/b1/task/b')
  }
