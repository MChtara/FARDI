...
const GAP_FILL_SENTENCES = [
  {
    id: 1,
    text: "We need to create a _______ to plan our spending.",
    correctAnswers: ['budget'],
    hint: 'A plan for money'
  },
  {
    id: 2,
    text: "The _______ gave us $500 for the event.",
    correctAnswers: ['sponsor'],
    hint: 'Person or company that gives money'
  },
  {
    id: 3,
    text: "Each _______ costs $10 to enter the festival.",
    correctAnswers: ['ticket'],
    hint: 'What people buy to attend'
  },
  {
    id: 4,
    text: "Our _______ shows we need $2,000 total.",
    correctAnswers: ['budget'],
    hint: 'Financial plan'
  },
  {
    id: 5,
    text: "The main _______ wants their logo on posters.",
    correctAnswers: ['sponsor'],
    hint: 'Company giving support'
  },
  {
    id: 6,
    text: "We sold 100 _______ in the first week.",
    correctAnswers: ['tickets'],
    hint: 'Entry passes (plural)'
  },
  {
    id: 7,
    text: "A good _______ helps us avoid overspending.",
    correctAnswers: ['budget'],
    hint: 'Money plan'
  },
  {
    id: 8,
    text: "The local café is our food _______.",
    correctAnswers: ['sponsor'],
    hint: 'Supporter'
  },
  {
    id: 9,
    text: "Online _______ sales start next Monday.",
    correctAnswers: ['ticket'],
    hint: 'Entry pass'
  },
  {
    id: 10,
    text: "Without a _______, we might spend too much money.",
    correctAnswers: ['budget'],
    hint: 'Financial plan'
  }
]
    ...
    <Box sx={{ maxWidth: 900, mx: 'auto', p: 3 }}>
      ...
      <Paper elevation={1} sx={{ p: 2, mb: 3, backgroundColor: 'info.lighter' }}>
        <Typography variant="body1" gutterBottom>
          <strong>Instructions:</strong> Select the correct word from the dropdown for each blank.
        </Typography>
