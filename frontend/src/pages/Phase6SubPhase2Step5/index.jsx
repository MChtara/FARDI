  ...
  return (
    <Box sx={{ maxWidth: 1200, mx: 'auto', p: 3 }}>
      <Paper elevation={0} sx={{ p: 3, mb: 3, background: 'linear-gradient(135deg, #8e44ad 0%, #6c3483 100%)', color: 'white', borderRadius: 2 }}>
        ...
        <Typography variant="h6">Step 5: Evaluate - Tone, Spelling, and Structure</Typography>
      </Paper>
      ...
      {wordshakeDone && (
        <Box sx={{ display: 'flex', justifyContent: 'center', mt: 4 }}>
          <Button variant="contained" size="large" onClick={() => navigate('/phase6/subphase/2/step/5/interaction/1')} startIcon={<PlayArrowIcon />}
