...
/**
 * Phase 6 SubPhase 1 Step 4 - Level A2 - Task C
  ...
  return (
    <Box sx={{ maxWidth: 900, mx: 'auto', p: 3 }}>
      ...
      <Alert severity="info" sx={{ mb: 3, borderRadius: 2 }}>
        Write a simple sentence for each number. Use the hint as your example.
      </Alert>
      ...
      <Stack spacing={2} sx={{ mb: 3 }}>
        {PROMPTS.map((prompt, idx) => (
          <Paper key={idx} elevation={1} sx={{ p: 2.5, borderRadius: 2 }}>
            ...
            <TextField fullWidth size="small" value={sentences[idx]} onChange={(e) => handleChange(idx, e.target.value)} disabled={submitted} placeholder="Write your sentence..." sx={{ backgroundColor: submitted ? '#f5f5f5' : 'white' }} />
          </Paper>
        ))}
      </Stack>
