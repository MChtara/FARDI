 ...
 * Complete dialogue correcting spelling/grammar
 * Score: +1 for each correct word (4 total: has, gatefold, has, animation)
 */

// Words that need to be filled in the dialogue
const WORD_BANK_ORIGINAL = [
  'has', 'gatefold', 'has', 'animation'
]
...
export default function Phase4Step5RemedialA2TaskA() {
    ...
    return (
      <Box sx={{ maxWidth: 1200, mx: 'auto', p: 3 }}>
        <Paper elevation={0} sx={{ p: 3, mb: 3, background: 'linear-gradient(135deg, #667eea 0%, #764ba2 100%)', color: 'white' }}>
          ...
          <Typography variant="h5">Level A2 - Task A: Dialogue Adventure Complete! 🎉</Typography>
        </Paper>
        <Paper elevation={6} sx={{ p: 4, textAlign: 'center', mb: 3 }}>
          <Typography variant="h3" gutterBottom fontWeight="bold" sx={{ color: '#667eea' }}>{score} / 4</Typography>
          <Typography variant="h6" color="text.secondary">Points Earned</Typography>
          <Typography variant="body1" sx={{ mt: 2 }}>Adventure Progress: {((score / 4) * 100).toFixed(0)}% Complete</Typography>
        </Paper>
        <Box sx={{ textAlign: 'center' }}>
          <Button variant="contained" size="large" onClick={() => navigate('/app/phase4/step/5/remedial/a2/taskB')} sx={{ py: 2, px: 6, fontSize: '1.1rem', fontWeight: 'bold', background: 'linear-gradient(135deg, #27ae60 0%, #229954 100%)', '&:hover': { background: 'linear-gradient(135deg, #229954 0%, #1e8449 100%)' } }}>
  ...
  return (
    <Box sx={{ maxWidth: 1200, mx: 'auto', p: 3 }}>
      <Paper elevation={0} sx={{ p: 3, mb: 3, background: 'linear-gradient(135deg, #667eea 0%, #764ba2 100%)', color: 'white' }}>
        <Typography variant="h4" gutterBottom fontWeight="bold">Phase 4 Step 5: Evaluate - Remedial Practice</Typography>
        <Typography variant="h5" gutterBottom>Level A2 - Task A: Dialogue Adventure 💬</Typography>
        <Typography variant="body1">Complete the dialogue correcting spelling and grammar!</Typography>
      </Paper>
