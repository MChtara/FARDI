    ...
    return (
      <Box sx={{ maxWidth: 1200, mx: 'auto', p: 3 }}>
        ...
        <Paper elevation={2} sx={{ p: 3, mb: 3 }}>
          <CharacterMessage
            character="LILIA"
            message="Excellent progress! Now test your knowledge with the Wordshake Quiz. You'll see 6 sentences with errors. For each one, identify whether it's a SPELLING, GRAMMAR, or PUNCTUATION error. You have 20 seconds per question. Good luck! 🎮"
          />
        </Paper>
