...
export default function Phase4Step5RemedialB1TaskA() {
  ...
  const handleContinue = () => {
    navigate('/phase4/step/5/remedial/b1/taskB')
  }
  ...
  return (
    <Box sx={{ maxWidth: 1200, mx: 'auto', p: 3 }}>
      ...
      <Paper elevation={2} sx={{ p: 3, mb: 3 }}>
        <CharacterMessage
          character="LILIA"
          message="Welcome to the Negotiation Battle! ⚔️ Complete the conversation about advertising poster and video design. Click a word from the Word Bank below, then click the blank space where it belongs. Fill all 4 gaps correctly to win the battle!"
        />
      </Paper>
