...
/**
 * Phase 4 Step 2 - Remedial B1 - Task D: Flashcard Game
...
export default function RemedialB1TaskD() {
  ...
  const completeGame = () => {
    ...
    sessionStorage.setItem('remedial_step2_b1_taskD_score', finalScore)
  ...
  // Completion screen
  if (gameCompleted) {
    const finalScore = sessionStorage.getItem('remedial_step2_b1_taskD_score') || knownCards.length
          ...
          <Box sx={{ color: 'white' }}>
            ...
            <Stack direction="row" spacing={2} justifyContent="center">
              ...
              <Button
                variant="contained"
                size="large"
                onClick={() => navigate('/app/phase4/step2/remedial/b1/taskE')}
                sx={{
                  py: 2,
                  px: 6,
                  fontSize: '1.2rem',
