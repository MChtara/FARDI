...
const QUIZ_QUESTIONS = [
  {
    ...
    correctIndex: 0,
    explanation: 'Promotional means to sell or promote a product or service.'
  },
  {
    id: 2,
    ...
    correctIndex: 0,
    explanation: 'Persuasive advertising uses ethos (credibility), pathos (emotion), and logos (logic).'
  },
  {
    id: 3,
    ...
    correctIndex: 0,
    explanation: 'Targeted advertising is aimed at a specific group of people.'
  },
  {
    id: 4,
    ...
    correctIndex: 0,
    explanation: 'Original means a new, unique idea that hasn\'t been copied.'
  },
  {
    id: 5,
    ...
    correctIndex: 0,
    explanation: 'Creative means using imagination to create something new and interesting.'
  },
  {
    id: 6,
    question: 'Ethical is?',
    ...
    correctIndex: 0,
    explanation: 'Ethical advertising is honest and fair, following moral principles.'
  }
]
...
export default function RemedialB1TaskC() {
  ...
  const moveToNextQuestion = () => {
    if (currentQuestionIndex + 1 < totalQuestions) {
      ...
      sessionStorage.setItem('remedial_step2_b1_taskC_score', score + (selectedAnswer === currentQuestion.correctIndex ? 1 : 0))
      logTaskCompletion(score + (selectedAnswer === currentQuestion.correctIndex ? 1 : 0))
    }
  }
  ...
  const handleContinue = () => {
    navigate('/app/phase4/step2/remedial/b1/taskD')
  }
      ...
      <Box sx={{ maxWidth: 1200, mx: 'auto', p: 3 }}>
        ...
        <Paper elevation={2} sx={{ p: 3, mb: 3 }}>
          <CharacterMessage
            ...
            message="Excellent progress! Now test your knowledge with this quiz. Answer 6 questions about advertising terminology. You have 20 seconds per question. Good luck!"
          />
        </Paper>
  ...
  if (quizCompleted) {
    const finalScore = sessionStorage.getItem('remedial_step2_b1_taskC_score') || score
