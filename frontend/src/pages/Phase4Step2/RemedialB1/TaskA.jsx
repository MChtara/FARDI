...
/**
 * Phase 4 Step 2 - Remedial B1 - Task A: Negotiation Battle
...
export default function RemedialB1TaskA() {
  ...
  const handleSubmit = async () => {
    ...
    sessionStorage.setItem('remedial_step2_b1_taskA_score', finalScore)
  ...
  const handleContinue = () => {
    navigate('/app/phase4/step2/remedial/b1/taskB')
  }
