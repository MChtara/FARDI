...
/**
 * Phase 4 Step 2 - Remedial B1 - Task F: Grammar Kahoot
...
export default function RemedialB1TaskF() {
  ...
  const finishGame = () => {
    ...
    sessionStorage.setItem('remedial_step2_b1_taskF_score', finalScore)
  ...
  const handleContinue = () => {
    ...
    navigate('/app/phase4/step2/remedial/b1/results')
  }
