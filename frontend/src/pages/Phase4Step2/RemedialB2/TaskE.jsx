...
/**
 * Phase 4 Step 2 - Remedial B2 - Task E: Conditional Challenge
...
export default function RemedialB2TaskE() {
  ...
  const handleSubmitAll = async () => {
    ...
    // Save score
    sessionStorage.setItem('remedial_step2_b2_taskE_score', totalScore)
  ...
  const handleContinue = () => {
    navigate('/app/phase4/step2/remedial/b2/taskF')
  }
      ...
      <Box sx={{ maxWidth: 1200, mx: 'auto', p: 3 }}>
        ...
        <Paper elevation={2} sx={{ p: 3, mb: 3 }}>
          <CharacterMessage
            ...
            message="Welcome to the Conditional Challenge! 🎯 Complete 6 conditional sentences using advertising terms from the videos. Use the correct conditional form (would + verb) to describe 'what if' scenarios. Each correct sentence = 1 point. Total: 6 points! Ready for the challenge? 🚀"
          />
        </Paper>
