...
/**
 * Phase 4 Step 2 - Remedial B2 - Task C: Kahoot Match
...
export default function RemedialB2TaskC() {
  ...
  const handleSubmit = () => {
    ...
    // Save score
    sessionStorage.setItem('remedial_step2_b2_taskC_score', correctMatches)
  ...
  const handleContinue = () => {
    navigate('/app/phase4/step2/remedial/b2/taskD')
  }
      ...
      <Box sx={{ maxWidth: 1200, mx: 'auto', p: 3 }}>
        ...
        <Paper elevation={2} sx={{ p: 3, mb: 3 }}>
          <CharacterMessage
            ...
            message="Welcome to Kahoot Match! 🎯 Match 8 advertising terms to their correct definitions in 2 minutes. Click a term, then click its matching definition. All correct matches = 8 points! Ready? Let's play! 🚀"
          />
        </Paper>
        ...
        <Paper elevation={6} sx={{ p: 4, textAlign: 'center', background: 'linear-gradient(135deg, #e67e22 0%, #d35400 100%)' }}>
          ...
          <Typography variant="h6" sx={{ color: 'white', mb: 4 }}>
            8 Terms • 8 Definitions • 2 Minutes • Match Them All!
          </Typography>
          ...
          <Box sx={{ color: 'white', textAlign: 'center' }}>
            ...
            {perfectScore && (
              <Alert severity="success" sx={{ mt: 2, backgroundColor: 'rgba(46, 204, 113, 0.9)' }}>
                <strong>Amazing!</strong> You matched all terms perfectly! You're a vocabulary master! 🌟
              </Alert>
            )}
          </Box>
        </Paper>
