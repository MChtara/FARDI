...
/**
 * Phase 4 Step 2 - Remedial B2 - Task B: Explain Expedition
...
export default function RemedialB2TaskB() {
  ...
  const evaluateAnswers = async () => {
    ...
    try {
      const response = await fetch('/api/phase4/step2/remedial/b2/evaluate-explanations', {
        method: 'POST',
      ...
      if (data.success) {
        ...
        sessionStorage.setItem('remedial_step2_b2_taskB_score', data.total_score)
  ...
  const handleContinue = () => {
    ...
    navigate('/app/phase4/step2/remedial/b2/taskC')
  }
