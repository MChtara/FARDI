...
/**
 * Phase 4 Step 2 - Remedial B2 - Task F: Grammar Role-Quest
...
export default function RemedialB2TaskF() {
  ...
  const handleSubmitAll = async () => {
    ...
    // Save score
    sessionStorage.setItem('remedial_step2_b2_taskF_score', totalScore)
  ...
  const handleContinue = () => {
    navigate('/app/phase4/step2/remedial/b2/results')
  }
      ...
      <Box sx={{ maxWidth: 1200, mx: 'auto', p: 3 }}>
        ...
        <Paper elevation={2} sx={{ p: 3, mb: 3 }}>
          <CharacterMessage
            ...
            message="Welcome to Grammar Role-Quest! 🎭 You'll play different advertising roles and complete their dialogues using the passive voice. Fill in 6 role-play lines with the correct passive form (is/are + past participle). Each correct line = 1 point. Total: 6 points! Ready to start your quest? 🚀"
          />
        </Paper>
    ...
    return (
      <Box sx={{ maxWidth: 1200, mx: 'auto', p: 3 }}>
        <Paper elevation={0} sx={{ p: 3, mb: 3, background: 'linear-gradient(135deg, #9b59b6 0%, #8e44ad 100%)', color: 'white' }}>
          ...
          <Typography variant="h5" gutterBottom>
            Level B2 - Task F: Grammar Role-Quest - Results 🏆
          </Typography>
        </Paper>
