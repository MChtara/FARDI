...
/**
 * Phase 4 Step 2 - Remedial C1 - Task G: Debate Duel Advanced
...
export default function RemedialC1TaskG() {
  ...
  const handleSubmitAll = async () => {
    ...
    // Save score
    sessionStorage.setItem('remedial_step2_c1_taskG_score', totalScore)
      ...
      >
        ...
        >
          ...
          <Box sx={{ mt: 4, display: 'flex', gap: 2, justifyContent: 'center' }}>
            <Button
              onClick={() => navigate('/app/phase4/step2/remedial/c1/taskH')}
              variant="contained"
              size="large"
              sx={{
                background: 'linear-gradient(45deg, #8e44ad 30%, #3498db 90%)',
