...
/**
 * Phase 4 Step 2 - Remedial C1 - Task C: Kahoot Quiz
...
export default function RemedialC1TaskC() {
  ...
  const handleFinishQuiz = (finalAnswers) => {
    ...
    // Save score
    sessionStorage.setItem('remedial_step2_c1_taskC_score', finalScore)
      ...
      <Box sx={{ maxWidth: 1200, mx: 'auto', p: 3 }}>
        ...
        <Paper elevation={2} sx={{ p: 3, mb: 3 }}>
          <CharacterMessage
            ...
            message="Welcome to the Kahoot Quiz! 🎯 Answer 6 rapid-fire questions about advertising concepts. You have 20 seconds per question. Select your answer quickly - the faster you answer correctly, the better! Score: 1 point per correct answer = 6 points total. Ready? Let's go! 🚀"
          />
        </Paper>
