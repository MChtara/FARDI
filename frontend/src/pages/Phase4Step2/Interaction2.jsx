...
/**
 * Phase 4 Step 2 Interaction 2: Watch Two Videos and Define "Dramatisation"
...
export default function Phase4Step2Interaction2() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (data.success !== false) {
        ...
        sessionStorage.setItem('phase4_step2_interaction2_score', data.score || 1)
      } else {
        setEvaluation({
          success: false,
          score: 0,
      ...
      if (score > 0) {
        sessionStorage.setItem('phase4_step2_interaction2_score', score)
        console.log(`[Phase 4 Step 2 - Interaction 2] Score: ${score}/5 | Level: ${level}`)
      }
    } finally {
      setLoading(false)
    }
  ...
  const handleContinue = () => {
    ...
    navigate('/app/phase4/step/2/interaction/3')
  }
